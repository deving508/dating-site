      ...
      <div className="flex flex-wrap mt-10 lg:mt-20">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-2 py-2">
            <div className="flex bg-neutral-900/50 pop-up justify-center items-center">
              <div className="flex mx-6 h-10 w-10 p-2 bg-neutral-900 text-red-800 justify-center items-center rounded-full">
                {feature.icon}  
              </div>
              <div className="pt-8">
                <h5 className="mt-1 mb-6 text-xl">{feature.text}</h5>
                <p className="text-md pr-2 mb-10 text-neutral-500">
                  {feature.description}
                </p>
              </div>
            </div>
